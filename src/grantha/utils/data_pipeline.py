...
from src.grantha.core.config import configs, DEFAULT_EXCLUDED_DIRS, DEFAULT_EXCLUDED_FILES
from src.grantha.utils.ollama_patch import OllamaDocumentProcessor
...
def count_tokens(text: str, is_ollama_embedder: bool = None) -> int:
    ...
    try:
        ...
        if is_ollama_embedder is None:
            from src.grantha.core.config import is_ollama_embedder as check_ollama
...
def prepare_data_pipeline(is_ollama_embedder: bool = None):
    ...
    """
    from src.grantha.core.config import get_embedder_config, is_ollama_embedder as check_ollama
