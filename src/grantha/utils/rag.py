...
from src.grantha.utils.embedder import get_embedder
from src.grantha.utils.prompts import RAG_SYSTEM_PROMPT as system_prompt, RAG_TEMPLATE
...
from src.grantha.core.config import configs
from src.grantha.utils.data_pipeline import DatabaseManager
...
class RAG(adal.Component):
    ...
    def __init__(self, provider="google", model=None, use_s3: bool = False):  # noqa: F841 - use_s3 is kept for compatibility
        ...
        from src.grantha.core.config import get_embedder_config, is_ollama_embedder
        ...
        if self.is_ollama_embedder:
            from src.grantha.utils.ollama_patch import check_ollama_model_exists
            from src.grantha.core.config import get_embedder_config
