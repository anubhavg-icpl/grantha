...
async def get_processed_projects():
    ...
    Projects are identified by files named like: grantha_cache_{repo_type}_{owner}_{repo}_{language}.json
    """
        ...
        for filename in filenames:
            if filename.startswith("grantha_cache_") and filename.endswith(".json"):
                ...
                try:
                    ...
                    # Example: grantha_cache_github_user_repository_en.json
                    # parts = [github, user, repository, en]
                    if len(parts) >= 4:
                        repo_type = parts[0]
                        owner = parts[1]
